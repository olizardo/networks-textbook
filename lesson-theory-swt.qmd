...
One influential approach to measuring tie strength, which distinguishes between factors that predict tie strength and indicators that show an existing tie's strength, is proposed by @marsden_campbell84. This model suggests a comprehensive way to assess tie strength by considering two factors: The **predictors of tie strength** and the **indicators of tie strength**.
