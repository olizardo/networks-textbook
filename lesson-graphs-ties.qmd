...
In @sec-types we began to discuss the way that sociologists and graph theory people classify ties and how they could be represented using different graphs. In this chapter we elaborate on these considerations and provide examples. 
