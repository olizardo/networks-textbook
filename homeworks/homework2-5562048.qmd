# Homework II: Directed Graphs {.unnumbered}
...
<br>
`r LETTERS[neighbors(gr, "E", mode = "in")]`
<br>

1. What is the **intersection** of the **out-neighborhoods** of nodes *A* and *I*?
<br>
`r intersect(LETTERS[neighbors(gr, "A", mode = "out")], LETTERS[neighbors(gr, "I", mode = "out")])`
<br>

1. What is the **intersection** of the **in-neighborhoods** of nodes *H* and *E*?
<br>
`r intersect(LETTERS[neighbors(gr, "H", mode = "in")], LETTERS[neighbors(gr, "E", mode = "in")])`
<br>

1. What is the **union** of the **out-neighborhoods** of nodes *G* and *K*?
<br>
`r union(LETTERS[neighbors(gr, "G", mode = "out")], LETTERS[neighbors(gr, "K", mode = "out")])`

<br>

1. What is the **union** of the **in-neighborhoods** of nodes *B* and *I*?
<br>
`r union(LETTERS[neighbors(gr, "B", mode = "in")], LETTERS[neighbors(gr, "I", mode = "in")])`
<br>
