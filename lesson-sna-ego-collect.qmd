...
- Details about ego (e.g.,  socio-demographic and other characteristics).
- The nature of relations (e.g., role, exchange, interaction) between the ego and their alters.
...
1. *Define the Relation of Interest*: The first crucial step is to specify the type of relationship the researcher wants to study. This definition directly informs the name generator, which is the question or prompt used to elicit names of each alter from the ego.
...
- **Interaction Approach**: This approach focuses on the frequency or duration of contact between the ego and others. An example is, "List the names of up to [X] of the people you most frequently interact with." The NetHealth study used an interaction-based name generator that allowed up to 20 alters.
