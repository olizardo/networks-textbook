...
## Multiplex Ties
Typically, we are tied to the same others via a multiplicity of ties. That is, we are tied to people via what anthropologists call **multiplex ties**. That is, a person we like may also be a person we hang out with, who may also share our ethnic identity (what, in @sec-egonets, we called **homophily**), who may also be someone we go to the movies with, and so on. 
