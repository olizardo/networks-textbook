# Homework VII: Ego-Network Metrics {.unnumbered}
...
#| fig-width: 10
    ...
    p4
```
@fig-altersdem-1 through @fig-altersdem-4 show some sociodemographic and role-relational characteristics of alters in ego's network. Ego is a *UCLA student who identifies as Black and as a Man*. Using this information:
