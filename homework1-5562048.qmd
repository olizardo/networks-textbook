# Homework I: Graph Theory {.unnumbered}
...
<br>
`r paste(sort(neighbors(gr, "C")$name), collapse = ", ")`
<br>

1. Write down the **neighborhood** of node **K**
<br>
`r paste(sort(neighbors(gr, "K")$name), collapse = ", ")`
<br>

1. What is the **intersection** of the neighborhoods of nodes **C** and **K**?
<br>
`r paste(sort(intersect(neighbors(gr, "C")$name, neighbors(gr, "K")$name)), collapse = ", ")`
<br>


1. What is the **intersection** of the neighborhoods of nodes **G** and **H**?
<br>
`r paste(sort(intersect(neighbors(gr, "G")$name, neighbors(gr, "H")$name)), collapse = ", ")`
<br>


1. What is the **union** of the neighborhoods of nodes **F** and **A**? 
<br>
`r paste(sort(union(neighbors(gr, "F")$name, neighbors(gr, "A")$name)), collapse = ", ")`
<br>
