...
By running this code, you will generate a visual grid showing exactly how the directed ties flow in each of the seven expected triads. You will clearly see the contrast between stable, hierarchical shapes like the transitive triad and the unstable, non-hierarchical flow of the cyclical triad, giving you a highly intuitive, graphical lens through which to analyze agonistic competition and the emergence of status orders.
What is the duality between persons and groups?
How do co-membership and group-overlap matrices differ?
How is a bipartite graph used to represent memberships?
```
