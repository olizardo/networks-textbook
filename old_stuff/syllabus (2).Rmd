...
- **On Mondays and Wednesdays starting around 12:30p Pacific Standard Time**, I will deliver a synchronous (live) Zoom lecture on that day's topic (for the first two weeks). And a live lecture at Broad 2160E thereafter. The current schedule of topics can be found on the Canvas website. **Attendance at the lecture is not required**, but highly encouraged. I have taught this class many times, and *I can guarantee you will do better in the class if you attend lectures regularly*. That is because *Asking questions and taking notes during live delivery of the material aids learning and retention*. 

- Nobody can pay attention on Zoom for 75 minutes. As such, Zoom lectures in the first two weeks of the quarter will be capped at around 50-60 mins. Regular in-person lectures will go for the scheduled 75 minutes. 

- This is the [Zoom link to join the live lectures](https://ucla.zoom.us/j/92384271059?pwd=TkVFV2xOYnBQeGN3QnhxNmhjWnJKdz09). It can also be found on the Canvas course site under the Zoom tab. 
...
- To prepare for each class, you should read all the material in advance, including slides and lesson readings, take notes, and prepare questions about anything that remains unclear.
...
4. You don't need to schedule an appointment for my student hours. My virtual doors (for the first two weeks) and actual doors (after that) are wide open during that time (check with your TA about their particular scheduling policy). 
...
- If you want to discuss course grades or other issues that pertain to your or your situation, come to my virtual office during student hours or contact me with two alternative time suggestions if these times do not work. During the first two weeks, student hours will take "place" in my **virtual office**. After that, student hours are in my real office, unless you request otherwise.
...
- *I am on the waitlist and I don't like it. I really want to get into this class. Scratch that. I need to get into this class or lots of bad things will happen and my life will be ruined forever. Can I have a PTE code so I can end this waitlist hell?*

> **No**. Unfortunately, dozens of students are probably in the same position. If I were to give a code for one to jump over from the waitlist I would have to do it for everyone, and the class enrollment would ballon to way over the 300 person limit and we would all suffer. So, if you are on the waitlist, the only thing that I can tell you is to hang tight, but I don't know for sure what the chances are that you'll make it, other than a smaller number is better. 
...
- *There are lots of concepts and terminology. Do I need to memorize every little definition?*

> **No**. The lesson handouts goes into more detail on the material and provide important background on key concepts. For the most part the lecture slides should be your guide as to what is important. If it is mentioned on both the lessons and the lecture, it will likely be in the exam. If it is mentioned in the lessons but not the lecture, I will not test you on it. 
