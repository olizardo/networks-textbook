...
So what is centrality? As we have seen in @sec-degcent, @sec-distcent, and @sec-pathcent, in terms of graph theory, a **centrality metric** is a summary index of a node's position in a graph, based on (sometimes weighted) *sums* or *averages* of one of three things [@borgatti_everett06]:
