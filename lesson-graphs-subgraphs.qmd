...
p <- p + geom_node_point(aes(x = x, y = y), size = 18, color = "tan2") 
p <- p + geom_node_text(aes(label = name), size = 8, color = "white")
p2 <- p + theme_graph() + coord_cartesian(clip = "off") + coord_cartesian(clip = "off")
p2
```
...
p <- p + geom_node_point(aes(x = x, y = y), size = 18, color = "tan2") 
p <- p + geom_node_text(aes(label = name), size = 8, color = "white")
p3 <- p + theme_graph() + coord_cartesian(clip = "off") + coord_cartesian(clip = "off")
p3
```
...
p <- p + geom_node_point(aes(x = x, y = y), size = 18, color = "tan2") 
p <- p + geom_node_text(aes(label = name), size = 8, color = "white")
p4 <- p + theme_graph() + coord_cartesian(clip = "off") + coord_cartesian(clip = "off")
p4
```
