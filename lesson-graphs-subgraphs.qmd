---
title: "Graphs and their Subgraphs"
---
...
A common reason for defining subgraphs in social network analysis is to examine what a network would look like if we were to remove an actor or a set of actors. Sometimes this is useful, when we want to get a sense of how important that set of actors is for holding the network together. 
...
A subgraph created by removing *only* edges, but leaving *all* the nodes of the original graph intact, like in @fig-subgraph-4, is also called a **spanning subgraph** of the original graph. 
