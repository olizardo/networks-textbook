...
ggplot(diffusion_data, aes(x = Time, y = Cumulative_Adoption)) +
  ...
  geom_vline(xintercept = t0, linetype = "dashed", color = "gray50", size = 0.8) +
  
  # Add annotations to explain the phases of the curve
  annotate("text", x = 2.5, y = 25, label = "Slow Initial\nAdoption", 
           color = "black", fontface = "italic", size = 4) +
  annotate("text", x = t0 - 1, y = 70, label = "Rapid Growth\n(Takeoff)", 
           color = "black", fontface = "italic", size = 4, hjust = 1) +
  annotate("text", x = 8, y = 90, label = "Market Saturation\n(Leveling Off)", 
           color = "black", fontface = "italic", size = 4) +
