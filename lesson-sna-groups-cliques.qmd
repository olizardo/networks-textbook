...
Of course, it would be silly to keep on going with values of n larger than three, since the subgraphs so defined would be so loosely connected as to no longer count as groups [@luce50, p. 176]. That's why, when defining n-cliques, values of $n$ in the range of 2 or 3 are most commonly used.
