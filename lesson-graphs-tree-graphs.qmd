...
1. Second, the one path connecting each pair of nodes is *unique*, that is, a sequence of nodes and edges that is distinctive for that node pair and does not repeat for any other pair. 
