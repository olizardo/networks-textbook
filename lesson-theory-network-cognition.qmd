...
3.  **Balance Bias (Transitivity Pressure):** Drawing from Heider's balance theory (see @sec-sbalance), our minds prefer closed, balanced triads. If $i$ knows that $j$ and $h$ are their friends, $i
...
::: {#refs}
:::
s brain will mentally "close" the triangle, perceiving $j$ and $h$ to be friends ($R_{jhi} = 1$) even if they have no connection.
