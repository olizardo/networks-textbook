...
::: {.incremental}
- For any simple, undirected graph $G$, we can formulate a fundamental mathematical theorem linking node-connectivity ($\kappa$), edge-connectivity ($\lambda$), and minimum degree ($\delta$):
