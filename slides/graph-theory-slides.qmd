...
- Two key concepts in edge deletion:
  - **Spanning Subgraph**: A subgraph that leaves all original nodes intact, removing only edges.
...
- The resulting spanning subgraph is shown on the right.
:::
:::
