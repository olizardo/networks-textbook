...
::: {.columns}
::: {.column width="45%"}
- Peter Marsden and Karen Campbell (1984) proposed a systematic framework to measure tie strength:
- **Predictors of Tie Strength**:
  - Factors that influence whether a strong tie is likely to form (Inputs).
  - Examples: *Role relations* (e.g., friend, kin) and *similarities/homophily* (shared memberships, socio-demographics).
- **Indicators of Tie Strength**:
  - Characteristics that reveal how strong an existing tie actually is (Outputs).
  - Examples: **Subjective closeness/intimacy** (most reliable indicator), *frequency of interaction*, *duration*, and *reciprocal support*.
:::
...
- Interpersonal ties are dynamic; they develop through qualitative developmental stages over time (Friedkin, 1990):

![](../images/swt-friedkin-stages.png){fig-align="center" width="90%"}
