...
- This progression moves from baseline behavioral interactions to cognitive trust, and finally to deep affective bonds.
- We can break this developmental model down into three distinct stages:
  1. **Frequent Discussion** (The interactional baseline)
  2. **Help Seeking** (Emerging instrumental trust)
  3. **Close Friendship** (The highest level of affective tie strength)
...
![](../images/swt-friedkin-reveal-1.png){fig-align="center" height="420px"}

---

## Visualizing the Stage Model: Step 2

![](../images/swt-friedkin-reveal-2.png){fig-align="center" height="420px"}

---

## Visualizing the Stage Model: Step 3

![](../images/swt-friedkin-reveal-3.png){fig-align="center" height="420px"}
...
## Causal Testing: The LinkedIn Experiment (Method)
