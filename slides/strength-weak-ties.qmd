...
- **Causal Method (Instrumental Variables)**:
  - Estimated causal effects using a **2-Stage Least Squares (2SLS) IV approach**, using randomized PYMK (People You May Know) algorithm variants (promoting weak vs. strong ties) as instruments.
...
- **1. Structural Strength (Neighborhood Overlap)**:
  ...
  - **The Paradox Reversal**: Correlational OLS showed strong ties are more strongly correlated with job finding. However, causal IV analysis *reversed* this, finding an **Inverted U-Shape Relationship**.
