...
# Layout for a 3-node grid for triad drawings
gr_triad_base <- create_empty(3, directed = TRUE)
l_triad <- ggraph(gr_triad_base, layout = 'grid')$data[, 1:2]
l_triad <- as.matrix(l_triad)
l_triad[3, 1] <- 0.5  # Form a nice triangle layout
```
