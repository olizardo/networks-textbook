...
- Ego networks are not "flat" lists of acquaintances; they are organized into **concentric layers** based on intimacy and closeness.
...
## Visualizing the Dunbar Circles

::: {.columns}
::: {.column width="45%"}
- Your personal network expands outwards from you (**Ego**).
- **Four concentric circles** define the standard Dunbar structure:
  - **Support Clique** (~5 people)
  - **Sympathy Group** (~15 people)
  - **Affinity Group** (~50 people)
  - **Active Network** (~150 people)
- Group size grows by a scaling factor of approximately **3x** with each successive layer.
:::

::: {.column width="55%"}
![](../images/dunbar-circles.png){fig-align="center" width="100%"}
:::
:::

---

## The Inner Layers: Support Clique & Sympathy Group
...
## The Outer Layers: Affinity Group & Active Network
