...
::: {.column width="50%"}
### Empty Adjacency Matrix progress
| | A | B | C | D | E |
|:---:|:---:|:---:|:---:|:---:|:---:|
| **A** | -- | ? | ? | ? | ? |
| **B** | ? | -- | ? | ? | ? |
...
- In any relationship matrix of order $N$, we can divide the cell entries into three distinct anatomical regions:
  1. **The Main Diagonal**:
     - Cells where the row index equals the column index ($i = j$). Blocked with a dash (`--`) for simple graphs.
  2. **The Upper Triangle**:
     - All cells located *above* the main diagonal where the row index is less than the column index ($i < j$).
  3. **The Lower Triangle**:
...
\color{red}{a_{11}} & \color{blue}{a_{12}} & \color{blue}{a_{13}} \
\color{green}{a_{21}} & \color{red}{a_{22}} & \color{blue}{a_{23}} \
\color{green}{a_{31}} & \color{green}{a_{32}} & \color{red}{a_{33}}
\end{pmatrix}$$
...
| | A | B | C | D | E |
|:---:|:---:|:---:|:---:|:---:|:---:|
| **A** | -- | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">0</span> | <span style="color: blue; font-weight: bold;">0</span> |
| **B** | <span style="color: green; font-weight: bold;">1</span> | -- | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">0</span> |
| **C** | <span style="color: green; font-weight: bold;">1</span> | <span style="color: green; font-weight: bold;">1</span> | -- | <span style="color: blue; font-weight: bold;">0</span> | <span style="color: blue; font-weight: bold;">1</span> |
| **D** | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">1</span> | <span style="color: green; font-weight: bold;">0</span> | -- | <span style="color: blue; font-weight: bold;">1</span> |
| **E** | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">1</span> | <span style="color: green; font-weight: bold;">1</span> | -- |

- Symmetrical pairs: $a_{AB} = a_{BA} = 1$ (Blue matches Green).
- Unconnected pairs: $a_{AD} = a_{DA} = 0$.
:::
...
## Asymmetric Matrices (Directed Case)

::: {.incremental}
- In a **directed graph**, relationship ties are unidirectional and asymmetric. Just because employee $i$ asks $j$ for advice does not mean $j$ asks $i$ back.
- This directed structure translates to an **asymmetric adjacency matrix**:
  - The cell value $A_{ij}$ is not necessarily equal to the cell value $A_{ji}$ ($A_{ij} \neq A_{ji}$).
  - The **Upper Triangle** represents ties sent from lower-indexed nodes to higher-indexed nodes ($i < j$).
  - The **Lower Triangle** represents ties sent from higher-indexed nodes to lower-indexed nodes ($i > j$).
- **No Redundancy**:
  - Because the triangles represent independent directional paths, we must analyze **both** triangles to capture the complete network structure.
:::
...
| **A** | -- | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">0</span> | <span style="color: blue; font-weight: bold;">0</span> |
| **B** | <span style="color: green; font-weight: bold;">1</span> | -- | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">1</span> | <span style="color: blue; font-weight: bold;">0</span> |
| **C** | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | -- | <span style="color: blue; font-weight: bold;">0</span> | <span style="color: blue; font-weight: bold;">1</span> |
| **D** | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | -- | <span style="color: blue; font-weight: bold;">0</span> |
| **E** | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">0</span> | <span style="color: green; font-weight: bold;">1</span> | -- |

- Reciprocal tie $A \leftrightarrow B$: $a_{AB} = 1$ and $a_{BA} = 1$ (Symmetric).
- Asymmetric tie $C \rightarrow E$: $a_{CE} = 1$ (Blue), but $a_{EC} = 0$ (Green).
- Asymmetric tie $B \rightarrow D$: $a_{BD} = 1$ (Blue), but $a_{DB} = 0$ (Green).
:::
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 10px; margin-top: 20px;">
  <div style="background-color: #343a40; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; width: 240px; text-align: center; border: 2px solid #ff7e26;">Real Social Network</div>
  <div style="font-size: 20px; font-weight: bold; color: #ff7e26;">↓ (Graph Theory)</div>
  <div style="background-color: #343a40; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; width: 240px; text-align: center; border: 2px solid #ff7e26;">Abstract Graph</div>
  <div style="font-size: 20px; font-weight: bold; color: #ff7e26;">↓ (Matrix Algebra)</div>
  <div style="background-color: #ff7e26; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; width: 240px; text-align: center; border: 2px solid #343a40;">Adjacency Matrix</div>
</div>
:::
